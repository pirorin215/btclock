...
fun LogDownloadScreen(viewModel: MainViewModel, onBack: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.screen_recorder_log)) },
                navigationIcon = {
        ...
        Column(
            ...
            if (logFiles.isNotEmpty()) {
                        ...
                        Card(modifier = Modifier.fillMaxWidth()) {
                            Row(
                                ...
                                Button(
                                    ...
                                    Icon(Icons.Default.Download, contentDescription = stringResource(R.string.download_button))
                ...
                Text(
                    text = stringResource(R.string.no_log_files_message),

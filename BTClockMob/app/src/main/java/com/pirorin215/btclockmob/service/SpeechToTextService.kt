...
import com.pirorin215.btclockmob.adpcm.AdpcmDecoder
        ...
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                if (bitDepth.toInt() == 4) {
                    ...
                    actualBitDepth = 16 // After decoding, it's 16-bit PCM
                } else {
                ...
                val encoding = when (actualBitDepth.toInt()) {
                    ...
                    else -> return@withContext Result.failure(Exception("Unsupported bit depth: $actualBitDepth"))
                }

                val audioBytes = ByteString.copyFrom(audioFileToTranscribe.readBytes())
                ...
                // Ensure temporary PCM file is deleted
                tempPcmFile?.delete()
            }
        }
    }
